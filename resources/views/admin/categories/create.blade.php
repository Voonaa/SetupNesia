<x-admin-layout>
    <x-slot name="header">
        <div class="flex items-center space-x-2 text-sm text-slate-400">
            ...
            <span>&middot;</span>
            <span class="text-slate-200">Create New Category</span>
        </div>
        ...
        <div class="bg-[#1E293B]/50 backdrop-blur-md border border-slate-800 rounded-2xl shadow-xl overflow-hidden relative">
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST" class="p-8 space-y-6">
                ...
                <div>
                    ...
                    <x-text-input id="name" name="name" type="text" class="mt-1.5 block w-full" :value="old('name')" required autofocus placeholder="e.g. Mechanical Keyboard" />
